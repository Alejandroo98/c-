...
namespace WebApplicationTest.Controllers
{
    public class DepartamentosController : Controller
    {
        ...
        {
            var departamento = _context.Departamentos.Include(departamento => departamento.Empleados).ToList();
            var totalEmpleados = departamento[0].Empleados.Count();


            var departamentosOtro = _context
                .Departamentos
                .Include(x => x.DepartamentoId)
                .Where( x => x.Nombre == "Tecnologia" )
            ...
            /* TAREA */
            // ¿Que expresion de linq to sql debe usarse para reemplazar el 0 por el numero de empleados?
            //Pista => SelectMany
